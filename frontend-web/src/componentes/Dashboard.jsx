...
import {
  ...
  GitBranch, FileText, Bell, ArrowRight, Mountain, ShieldCheck, Ruler
} from 'lucide-react';
...
const MODULOS = [
  ...
  { id: 'bienestar',      titulo: 'Bienestar Animal',      descripcion: 'Evaluación del bienestar del hato según la metodología MEBA del ICA. Califica recursos, animal y gestión, y conoce qué falta para alcanzar el nivel Excelente.', ruta: '/bienestar',      Icono: ShieldCheck, color: 'bg-green-600',  colorCard: 'from-green-50 to-emerald-100',   imagen: '/img/ModuloBienestar.png',   ring: 'ring-green-200',   btn: 'bg-green-600 hover:bg-green-700' },
  { id: 'clasificacion',  titulo: 'Clasificación Lineal',  descripcion: 'Evaluación fenotípica morfológica de cada animal (método ADGA). Califica apariencia, estructura, sistema mamario y patas, con fotos de evidencia para una selección más precisa.', ruta: '/clasificacion-lineal', Icono: Ruler, color: 'bg-rose-500', colorCard: 'from-rose-50 to-pink-100', imagen: '/img/ModuloClasificacion.png', ring: 'ring-rose-200', btn: 'bg-rose-600 hover:bg-rose-700' },
